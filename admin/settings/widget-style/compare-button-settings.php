...
class WPEC_Compare_Widget_Compare_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Widget Compare Button Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Widget Compare Button Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Widget Compare Button Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Compare Button', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Compare Widget Button / Hyperlink ', 'wp-ecommerce-compare-products' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( 'Compare Widget Button/Hyperlink Position', 'wp-ecommerce-compare-products' ),
			...
			array(
            	'name' 		=> __( 'Compare Widget Hyperlink Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'type' 		=> 'text',
				'default'	=> __('Compare', 'wp-ecommerce-compare-products' )
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Widget Button Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
