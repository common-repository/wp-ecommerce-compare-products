...
class WPEC_Compare_Comparison_Page_Print_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Print Page Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Print Page Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Print Page Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'print-page',
			'label'				=> __( 'Print Page', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( "Print Comparison Page Feature", 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( "Print Page Feature", 'wp-ecommerce-compare-products' ),
			...
			array(
            	'name' 		=> __( "Print Page Message", 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Print Page Message Text', 'wp-ecommerce-compare-products' ),
				'desc' 		=> __( "Default <code>'[default_value]'</code>", 'wp-ecommerce-compare-products' ),
				'id' 		=> 'print_message_text',
				'type' 		=> 'text',
				'default'	=> __('Refine selections to 3 products and print!', 'wp-ecommerce-compare-products' )
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Table Print Button / Hyperlink', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Table Print Hyperlink Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'id' 		=> 'print_link_text',
				'type' 		=> 'text',
				'default'	=> __('Print this page', 'wp-ecommerce-compare-products' )
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Compare Table Print Button Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
