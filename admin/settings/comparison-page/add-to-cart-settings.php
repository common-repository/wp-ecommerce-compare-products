...
class WPEC_Compare_Comparison_Page_AddToCart_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Add to Cart Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Add to Cart Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Add to Cart Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'add-to-cart',
			'label'				=> __( 'Add to Cart', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( "Add to Cart Feature", 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( "Add To Cart Link", 'wp-ecommerce-compare-products' ),
			...
			array(
            	'name' => __( 'Add To Cart Button / Hyperlink', 'wp-ecommerce-compare-products' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(  
				'name' 		=> __( 'Added To Cart Success Icon', 'wp-ecommerce-compare-products' ),
			...
			array(
            	'name' 		=> __( 'Add To Cart Hyperlink Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
			...
			array(  
				...
				'type' 		=> 'text',
				'default'	=> __('Add to cart', 'wp-ecommerce-compare-products' )
			),
			array(  
			...
			array(
            	'name' 		=> __( 'Add To Cart Button Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
