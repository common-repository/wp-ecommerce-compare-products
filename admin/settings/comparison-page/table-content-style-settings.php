...
class WPEC_Compare_Comparison_Table_Content_Style_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Table Content Style successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Table Content Style can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Table Content Style successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Table Content Style', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Compare Feature Titles (Left Fixed Column)', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( "Title Alignment", 'wp-ecommerce-compare-products' ),
			...
			array(  
				'name' 		=> __( 'Title Font', 'wp-ecommerce-compare-products' ),
			...
			array(
            	'name' 		=> __( 'Table Rows Feature Values Font', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Values Font', 'wp-ecommerce-compare-products' ),
				'id' 		=> 'content_font',
				'type' 		=> 'typography',
			...
			array(
            	'name' 		=> __( 'Empty Feature Values Row Cell Display', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Default Text', 'wp-ecommerce-compare-products' ),
				'desc' 		=> __( "if nothing is enter in here nothing shows", 'wp-ecommerce-compare-products' ),
				'id' 		=> 'empty_text',
				'type' 		=> 'text',
				'style'		=> 'width:160px;',
				'default'	=> '',
			...
			array(  
				'name' 		=> __( 'Cell Background Colour', 'wp-ecommerce-compare-products' ),
			...
			array(  
				'name' 		=> __( 'Font', 'wp-ecommerce-compare-products' ),
				'id' 		=> 'empty_font',
				'type' 		=> 'typography',
				'default'	=> array( 'size' => '12px', 'face' => 'Arial, sans-serif', 'style' => 'normal', 'color' => '#000000' )
			),
			...
			array(
            	'name' 		=> __( 'Product Name Font', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Font', 'wp-ecommerce-compare-products' ),
