...
class WPEC_Compare_GridView_Compare_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Card Compare Button Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Product Card Compare Button Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Product Card Compare Button Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			'name'				=> 'compare-button',
			'label'				=> __( 'Product Card Compare Button', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' => __( 'Product Card Compare Button / Hyperlink ', 'wp-ecommerce-compare-products' ),
                'type' => 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( 'Product Card Compare Hyperlink Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
			...
			array(
            	'name' 		=> __( 'Product Card Compare Button Styling', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
