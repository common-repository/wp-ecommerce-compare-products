...
class WPEC_Compare_GridView_View_Compare_Button_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'View Compare Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: View Compare Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'View Compare Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( "View Compare on Product Cards", 'wp-ecommerce-compare-products' ),
