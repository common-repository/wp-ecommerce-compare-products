...
class WPEC_Compare_Product_Page_Compare_Tab_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Page Compare Feature Fields Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Product Page Compare Feature Fields Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Product Page Compare Feature Fields Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Product Page Compare Feature Fields', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			array(
            	'name' 		=> __( "Product Page Compare Feature Fields", 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( "Compare Features Fields", 'wp-ecommerce-compare-products' ),
