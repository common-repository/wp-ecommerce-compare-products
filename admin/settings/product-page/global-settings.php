...
class WPEC_Compare_Product_Page_Global_Settings extends WPEC_Compare_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Product Page Settings successfully saved.', 'wp-ecommerce-compare-products' ),
				'error_message'		=> __( 'Error: Product Page Settings can not save.', 'wp-ecommerce-compare-products' ),
				'reset_message'		=> __( 'Product Page Settings successfully reseted.', 'wp-ecommerce-compare-products' ),
			);
	...
	public function after_save_settings() {
		if ( ( isset( $_POST['bt_save_settings'] ) || isset( $_POST['bt_reset_settings'] ) ) && get_option( 'wpec_compare_product_clean_on_deletion' ) == 0  )  {
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Product Page Settings', 'wp-ecommerce-compare-products' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			array(
            	'name' 		=> __( "Show Compare On Product Pages", 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
			...
			array(
            	'name' 		=> __( "Product Page Compare Button/Link Position", 'wp-ecommerce-compare-products' ),
			...
			array(  
				...
				'desc'		=> __( 'Position relative to Add to Cart button location', 'wp-ecommerce-compare-products' ),
			...
			array(  
				'name' 		=> __( "Manually set Compare button position", 'wp-ecommerce-compare-products' ),
				'desc'		=> __( "ON to deactivate default button position settings created by the plugin.", 'wp-ecommerce-compare-products' ).'<br />'.__('Then use this function to manually postion the Compare button on product pages', 'wp-ecommerce-compare-products' )."<br /><code>&lt;?php if ( function_exists('wpec_add_compare_button' ) ) echo wpec_add_compare_button(); ?&gt;</code>",
				'id' 		=> 'auto_add',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 'yes',
				'checked_value'		=> 'no',
			...
			array(
            	'name' 		=> __( 'House Keeping :', 'wp-ecommerce-compare-products' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Clean up on Deletion', 'wp-ecommerce-compare-products' ),
				'desc' 		=> __( "On deletion (not deactivate) the plugin will completely remove all tables and data it created, leaving no trace it was ever here.", 'wp-ecommerce-compare-products' ),
				'id' 		=> 'wpec_compare_product_clean_on_deletion',
				'type' 		=> 'onoff_checkbox',
				'default'	=> 1,
